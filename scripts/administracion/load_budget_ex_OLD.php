    ...
    <body>
        <div>
            <?php
				...
				// Table.
				$sqlTable = "SELECT id, acta, fecha_inicio_acta, fecha_fin_acta, departamento, proceso, tecnologia, contrato, valor FROM ejecucion_presupuesto";
							...
							echo "<tr>";
								...
								echo "<td align='center'>";
									echo "<select id='department' name='department' style='width:140px;'>";
										echo "<option value='Antioquia'>Antioquia</option>";
										...
										echo "<option value='Cundinamarca'>Cundinamarca</option>";
								...
								echo "<td align='center'>";
									echo "<select id='responsible' name='responsible' style='width:85px;'>";
										echo "<option value='ENECON'>ENECON</option>";
										echo "<option value='INGELEL'>INGELEL</option>";
										echo "<option value='INMEL'>INMEL</option>";
										echo "<option value='RYE'>RYE</option>";
									echo "</select>";
								echo "</td>"; 
