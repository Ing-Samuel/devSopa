...
<html>
    ...
    <body>
            ...
            <?php
				...
				if (isset($_POST["save"])) {
					if (($_POST["year"] != "") && ($_POST["homepassed"] != "")) {
						...
						$sqlUpdate = "UPDATE hfcb2b_rollout SET fecha_balance = '".$date."', year = ".trim($_POST["year"]).", mes = '".$_POST["month"]."', ciudad = '".$_POST["city"]."', tipo = '".$_POST["type"]."', homepassed = ".trim($_POST["homepassed"])." WHERE id = ".$id;   
						$resultUpdate = mysqli_query($db, $sqlUpdate);
						//echo $sqlUpdate;
						echo "<script type='text/javascript'>";
							echo "window.location = 'load_hfcb2b_rollout.php';";
						echo "</script>";
					} else {
						$error1 = true;
					}
				...
				// Table.
				$sqlTable = "SELECT id, year, mes, ciudad, tipo, homepassed FROM hfcb2b_rollout WHERE id = ".$id;
        ...
        <div id="main">
            <center><h3>UPDATE HFCB2B ROLLOUT</h3>
            <br>
			<form id="updatehfcb2b" method="POST" action="update_hfcb2b_rollout.php">
        ...
        <script type="text/javascript">
			...
			function selected(selectobj1){
                document.getElementById("updatehfcb2b").submit();
            }		
		</script>
    </body>
</html>