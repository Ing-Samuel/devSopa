...
<html>
    ...
    <body>
            ...
            <?php
				...
				if (isset($_POST["save"])) {
					if (($_POST["year"] != "") && ($_POST["homepassed"] != "")) {
						...
						$sqlUpdate = "UPDATE gpon_etp_rollout SET fecha_balance = '".$date."', year = ".trim($_POST["year"]).", mes = '".$_POST["month"]."', ciudad = '".$_POST["city"]."', homepassed = ".trim($_POST["homepassed"])." WHERE id = ".$id;   
						$resultUpdate = mysqli_query($db, $sqlUpdate);
						//echo $sqlUpdate;
						echo "<script type='text/javascript'>";
							echo "window.location = 'load_gpon_etp_rollout.php';";
						echo "</script>";
					} else {
						$error1 = true;
					}
				...
				// Table.
				$sqlTable = "SELECT id, year, mes, ciudad, homepassed FROM gpon_etp_rollout WHERE id = ".$id;
        ...
        <div id="main">
            <center><h3>UPDATE GPON ETP ROLLOUT</h3>
            <br>
			<form id="updategpon" method="POST" action="update_gpon_etp_rollout.php">
